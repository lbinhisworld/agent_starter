...
- **核心准则类文档**（各角色目录下的 `00-core.md`）**≤ 200 行**；超长内容拆到 `01-context.md` / `02-playbooks.md`。
...
- **owner 实现门禁**（`ARCH-20260326-02`）：architect owner 未获「你直接改 / 你来实现 / 你亲自落代码 / 直接提交补丁」等明确授权前，只允许更新**文档、台账、规则文件**，不得直接修改 `frontend-vue/`、`backend/` 业务代码。
